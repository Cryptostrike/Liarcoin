...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Liarcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"liarcointools.com", "dnsseed.liarcointools.com"},
    {"liarcoinpool.org", "dnsseed.liarcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"liarcointools.com", "testnet-seed.liarcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Liarcoin is probably already running."), addrBind.ToString().c_str());
        else
